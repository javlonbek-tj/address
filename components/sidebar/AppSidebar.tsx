              ...
              .map((item) => (
                ...
                >
                  <SidebarMenuButton
                    ...
                    tooltip={item.title}
                    className='data-[active=true]:bg-blue-500/10 hover:bg-sidebar-accent/50 dark:data-[active=true]:bg-sidebar-accent px-5 group-data-[state=collapsed]:px-3 border-transparent data-[active=true]:border-blue-500 border-l-2 group-data-[state=collapsed]:border-l-0 rounded-none h-12 data-[active=true]:text-blue-600 transition-all duration-300 dark:data-[active=true]:text-sidebar-accent-foreground'
                  >
                    ...
                    {[
                      ...
                      <SidebarMenuItem key={subItem.href}>
                        <SidebarMenuButton
                          ...
                          className='data-[active=true]:bg-blue-500/5 hover:bg-sidebar-accent/50 px-8 group-data-[state=collapsed]:px-3 border-transparent data-[active=true]:border-blue-500 border-l-2 group-data-[state=collapsed]:border-l-0 rounded-none h-10 transition-all duration-300'
                        >
